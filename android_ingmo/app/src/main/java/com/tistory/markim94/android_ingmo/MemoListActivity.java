...
public class MemoListActivity extends AppCompatActivity {
    ...
    public void testingAddItem(){
        ...
        memoListAdapter.addItem(new MemoListItem("2","2013년 1월 22일","나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모","false"));
        memoListAdapter.addItem(new MemoListItem("3","2013년 1월 22일","나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모나의 메모","false"));
